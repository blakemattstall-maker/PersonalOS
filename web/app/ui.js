...
export function Page({ children }) {
  return (
    // AppFrame owns the viewport. A short page fills its internal scroll area;
    // a long page grows inside it. The page itself never claims another 100vh,
    // which previously created empty scroll space and let Safari move the nav.
    <div className="flex min-h-full flex-col bg-paper">
      <main className="pos-safe-top mx-auto min-h-full w-full max-w-[34rem] flex-1 px-5 pb-32">
        {children}
      </main>
    </div>
  );
